...
PICS = (environ.get('PICS', 'https://telegra.ph/file/acf0c0d08b9bd175bb13c.jpg')).split()
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/jointypeit')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/haris_garage')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'harisgaragesupportgrp')
